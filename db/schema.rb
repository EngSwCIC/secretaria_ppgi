...
ActiveRecord::Schema.define(version: 2020_11_14_202425) do
  ...
  create_table "accreditations", force: :cascade do |t|
    ...
    t.date "start_date"
    t.date "end_date"
    t.bigint "sei_process_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["sei_process_id"], name: "index_accreditations_on_sei_process_id"
  ...
  add_foreign_key "accreditations", "sei_processes"
