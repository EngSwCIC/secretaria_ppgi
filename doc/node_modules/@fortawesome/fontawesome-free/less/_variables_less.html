...
<title>_variables.less - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/@fortawesome/fontawesome-free/less/_variables.less">

<p>// Variables // ————————–</p>

<p>@fa-font-path:         “../webfonts”; @fa-font-size-base:    16px; @fa-font-display:      block; @fa-line-height-base:  1; @fa-css-prefix:        fa; @fa-version:           “5.15.1”; @fa-border-color:      eee; @fa-inverse:           fff; @fa-li-width:          2em; @fa-primary-opacity:   1; @fa-secondary-opacity: .4;</p>
