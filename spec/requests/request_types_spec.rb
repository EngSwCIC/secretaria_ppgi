...
RSpec.describe "/request_types", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      RequestType.create! valid_attributes
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new RequestType" do
        expect {
          post request_types_url, params: { request_type: valid_attributes }
        }.to change(RequestType, :count).by(1)
      end

      it "redirects to the created request_type" do
        post request_types_url, params: { request_type: valid_attributes }
        expect(response).to redirect_to(request_type_url(RequestType.last))
      end
    end

    context "with invalid parameters" do
      it "does not create a new RequestType" do
        expect {
          post request_types_url, params: { request_type: invalid_attributes }
        }.to change(RequestType, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested request_type" do
        request_type = RequestType.create! valid_attributes
        patch request_type_url(request_type), params: { request_type: new_attributes }
        request_type.reload
      ...
      it "redirects to the request_type" do
        ...
        patch request_type_url(request_type), params: { request_type: new_attributes }
        request_type.reload
        expect(response).to redirect_to(request_type_url(request_type))
      end
    end
    ...
    context "with invalid parameters" do
      it "renders a successful response (i.e. to display the 'edit' template)" do
        request_type = RequestType.create! valid_attributes
        patch request_type_url(request_type), params: { request_type: invalid_attributes }
        expect(response).to be_successful
      end
    end
  end
