...
RSpec.describe ComentariosController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: comentario.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      comentario = Comentario.create! valid_attributes
      get :edit, params: {id: comentario.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {comentario: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        comentario = Comentario.create! valid_attributes
        put :update, params: {id: comentario.to_param, comentario: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested comentario" do
      comentario = Comentario.create! valid_attributes
      expect {
        delete :destroy, params: {id: comentario.to_param}, session: valid_session
      }.to change(Comentario, :count).by(-1)
    end
