Given("Que Usuario esteja logado como email {string} e com a senha {string}")_ do |string, string2|
  visit '/users/sign_in'
...
And("Esteja página inicial e logado") do
  ...
  Then("O usuário preenche os campos de texto {field} e {value}") do |field, value|
    pending
  end
