...
Funcionalidade: Prazo
    ...
    Cenário: Editar um prazo como um administrador
        Dado que meu banco de dados está inicializado com os prazos das solicitações
        E que eu estou na "página de prazos" e eu estou logado como "administrador"
        Quando eu aperto no botão "Editar" na linha "1"
        E eu seleciono o valor "39" na lista "setup_inicio_5i"
        E eu seleciono o valor "01" na lista "setup_fim_5i"
        E eu aperto no botão "Atualizar Prazo"
        Então eu espero ver "Prazo atualizado com sucesso."

    Cenário: Ver um prazo como um usuário
        Dado que meu banco de dados está inicializado com os prazos das solicitações
        E que eu estou na "página de prazos" e eu estou logado como "estudante"
        Então eu espero ver o botão "Mostrar"
