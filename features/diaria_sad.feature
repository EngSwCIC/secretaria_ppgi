...
Funcionalidade: Diárias
    ...
    Contexto: 
        ...
        Cenário: Solicitar o benefício de diárias sendo um estudante sem informar a data, origem, destino e descrição
            Dado que eu estou na "home" e eu estou logado como "estudante"
            Quando eu aperto no botão "Solicitações"
            E eu aperto no botão "Nova Solicitação"
            Quando eu seleciono o valor "Diária" na lista "solicitation_kind"
        ...
        Cenário: Solicitar o benefício de diárias sendo um estudante sem informar a data, origem e descrição
            Dado que eu estou na "home" e eu estou logado como "estudante"
            Quando eu aperto no botão "Solicitações"
            E eu aperto no botão "Nova Solicitação"
            Quando eu seleciono o valor "Diária" na lista "solicitation_kind"
        ...
        Cenário: Solicitar o benefício de diárias sendo um estudante sem informar a data, origem e destino
            Dado que eu estou na "home" e eu estou logado como "estudante"
            Quando eu aperto no botão "Solicitações"
            E eu aperto no botão "Nova Solicitação"
            Quando eu seleciono o valor "Diária" na lista "solicitation_kind"
