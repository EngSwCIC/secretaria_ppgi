class InformationController < ApplicationController
  ...
  def index
    ...
    if params[:information][:source_id]
      @information = Information.filter[:information][:source_id] if params[:information]&& params[:information][source_id] !=""
    else
  ...
  private
    ...
    def information_params
      params.require(:information).permit(:id, :title, :content, :source_id, :published_by)
    end
end
