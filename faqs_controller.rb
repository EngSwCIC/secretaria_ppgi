class FaqsController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @faq.save
          format.html { redirect_to @faq, alert: 'Faq was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @faq.update(faq_params)
          format.html { redirect_to @faq, alert: 'Faq was successfully updated.' }
    ...
    def destroy
      @faq.destroy
      respond_to do |format|
        format.html { redirect_to faqs_url, alert: 'Faq was successfully destroyed.' }
